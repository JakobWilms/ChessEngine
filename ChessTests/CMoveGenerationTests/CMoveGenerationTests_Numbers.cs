...
public class CMoveGenerationTestsNumbers
{
    ...
    {
        Assert.AreEqual(20, CMoveGeneration.MoveGenCount(Board));
    }
    ...
    public void MoveGeneration_Depth2_PreTest()
    {
        ...
        moves[0]!.Make(Board);
        Assert.AreEqual(20, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    public void MoveGeneration_Depth5_PreTest()
    {
        ...
        new CMove(CSquare.D7, CSquare.D5, Board).Make(Board);
        CMove cMove = new CMove(CSquare.E4, CSquare.D5, Board);
        cMove.Print();
    ...
    public void MoveGen_Pos2_Depth1()
    {
        ...
        Assert.AreEqual(48, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    public void MoveGen_Pos3_Depth1()
    {
        ...
        Assert.AreEqual(14, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    public void MoveGen_Pos4_Depth1()
    {
        ...
        Assert.AreEqual(6, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    public void MoveGen_Pos4_Depth4_PreTest()
    {
        ...
        Assert.AreEqual(39, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    public void MoveGen_Pos5_Depth1()
    {
        ...
        Assert.AreEqual(44, CMoveGeneration.MoveGenCount(Board));
    }
    ...
    public void MoveGen_Pos6_Depth1()
    {
        ...
        Assert.AreEqual(46, CMoveGeneration.MoveGen(Board).Length);
    }
    ...
    {
        if (n == 0) return CMoveGeneration.MoveGenCount(Board);
        CMove?[] moves = CMoveGeneration.MoveGen(Board);
        long moveCount = 0;
        for (var index = 0; index < moves.Length; index++)
        {
